...
export default async function LoginPage() {
  ...
  return (
    <div className="flex bg-[#faf9fa] text-black w-2/3 ml-40 max-h-full">
      <div className="flex flex-col basis-1/3 min-h-full py-12 pl-12 text-right justify-center">
        <div className="border-r-4 pr-8">
          ...
          <div className="navigation my-10">
            <ul className="">
              ...
              <li className="text-[80px] font-semibold">
                <a href={`/#what`}>What</a>
              </li>
              <li className="text-[24px] font-semibold">
                <a href={`/#why`}>Why</a>
      ...
      <div className="flex flex-col basis-2/3 max-h-[calc(100vh-64px)]">
        <div className="my-10 px-20 max-h-full overflow-y-auto scroll-smooth scrollbar-hidden">
